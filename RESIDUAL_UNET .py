...
# hyper parameters
model_name = "res_unet_membrane.hdf5"
...
h = model.fit(d.Xtrain, d.Ytrain, batch_size = 8, epochs = 100, validation_data = (d.Xtest, d.Ytest), callbacks = [tensorboard, model_checkpoint])
